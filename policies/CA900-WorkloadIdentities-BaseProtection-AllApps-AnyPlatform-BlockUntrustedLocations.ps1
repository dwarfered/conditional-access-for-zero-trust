...
<#
    .SYNOPSIS
        CA Policy: CA900-WorkloadIdentities-BaseProtection-AllApps-AnyPlatform-BlockUntrustedLocations

    .DESCRIPTION
        Workload Identities are blocked from untrusted locations.
...
$policyName = 'CA900-WorkloadIdentities-BaseProtection-AllApps-AnyPlatform-BlockUntrustedLocations'
