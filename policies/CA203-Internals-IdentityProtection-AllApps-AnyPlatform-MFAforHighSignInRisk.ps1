...
<#
    .SYNOPSIS
        CA Policy: CA203-Internals-IdentityProtection-AllApps-AnyPlatform-MFAforHighSignInRisk
...
$policyName = 'CA203-Internals-IdentityProtection-AllApps-AnyPlatform-MFAforHighSignInRisk'
