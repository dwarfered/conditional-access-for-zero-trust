...
<#
    .SYNOPSIS
        CA Policy: CA403-Guests-IdentityProtection-AllApps-AnyPlatform-BlockLegacyAuth
...
$policyName = 'CA403-Guests-IdentityProtection-AllApps-AnyPlatform-BlockLegacyAuth'
