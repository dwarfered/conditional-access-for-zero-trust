...
<#
    .SYNOPSIS
        CA Policy: CA205-Internals-AppProtection-MicrosoftIntuneEnrollment-AnyPlatform-MFA
...
$policyName = 'CA205-Internals-AppProtection-MicrosoftIntuneEnrollment-AnyPlatform-MFA'
